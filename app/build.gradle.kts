...
if (!plugins.hasPlugin("com.google.android.libraries.mapsplatform.secrets-gradle-plugin")) {
    plugins.apply("com.google.android.libraries.mapsplatform.secrets-gradle-plugin")
}
