...
fun AddressUpdateDialog(
  ...
  val buttonColors =
      ButtonDefaults.buttonColors(backgroundColor = Color(0xFF2490DF), contentColor = Color.White)
  ...
  AlertDialog(
      ...
      dismissButton = { Button(onClick = onDismiss, colors = buttonColors) { Text("Cancel") } })
}
